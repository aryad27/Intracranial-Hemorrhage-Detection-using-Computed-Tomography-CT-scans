...
class CTICHDataset(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        mask = Image.open(os.path.join(self.opt.dataroot,'label', img_path[0]+'.png' )).convert('L')

        imgs = Image.open(os.path.join(self.opt.dataroot,'image', img_path[0]+'.png' )).convert('L')
        img_path = os.path.join(self.opt.dataroot,'image', img_path[0]+'.png')
