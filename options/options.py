...
def create_options():
    ...
    # training
    base.add_argument("--batch_size", type=int, default=4, help="size of the images to load")
    base.add_argument("--n_epochs", type=int, default=150, help="number of epochs to train for")
